...
export default class RepresentativeForm extends Component {
  ...
  render() {
    if (this.state.existingEntry === true) {
      return <Redirect to="/dashboard/petitions" />;
    } else {
      return (
        <form className="representative-form" onSubmit={this.handleSubmit}>
          ...
          <div className="checkbox-container">
            <label
              htmlFor="infrastructureCheckbox"
          ...
          <label className="confirmation" htmlFor="confirmation">
            ...
            entrusted in me, and do so with no malicious intent. I understand
            that the information on this site may not be final or binding, and
            that the people of the community have the final say.
          </label>
