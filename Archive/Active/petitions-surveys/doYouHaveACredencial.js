...
export default class DoYouHaveACredencial extends Component {
  constructor(props) {
    ...
    this.state = { has_credencial: false, expiration_date: null };
  }
      ...
      return (
        <form className="representative-form" onSubmit={this.handleSubmit}>
          ...
          <h3>
            ...
            to find out who in our community has a Mexican Credencial so we can
            help everyone be involved in our communities future.
            <br></br>
