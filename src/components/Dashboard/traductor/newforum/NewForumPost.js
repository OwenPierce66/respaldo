...
const NewForumPost = (props) => {
    ...
    const deletePost = () => {
        if (confirm("Confirm You Want To Delete Comment.")) {
            Axios.delete(`http://127.0.0.1:8000/newforum/${post.id}/`, {
                headers: {
                    Authorization: `Token ${localStorage.getItem("userTokenLG")}`,
                },
            })
    ...
    const getPost = () => {
        Axios.get(`http://127.0.0.1:8000/newforum/${postId}`, {
            headers: {
                Authorization: `Token ${localStorage.getItem("userTokenLG")}`,
            },
        }).then((res) => {
    ...
    const getComments = () => {
        Axios.get(`http://127.0.0.1:8000/newforum/${postId}/comments/`, {
            headers: {
                Authorization: `Token ${localStorage.getItem("userTokenLG")}`,
            },
        }).then((res) => {
            ...
            <div className="forumPost">
                <div className="forumPostHeader">
                    ...
                    <div className="forumPostOptions">
                        <a href="/dashboard/newcommunity/">Back to Community</a>
