...
export default class ClassifiedsVehicleListing extends Component {
  ...
  getItem() {
    ...
    Axios.get(`http://127.0.0.1:8000/api/listing/vehicles/?vehicleId=${id}`, {
      headers: {
    ...
    Axios.get(`http://127.0.0.1:8000/api/listing/favorites/?vehicleId=${id}`, {
      headers: {
        Authorization: `Token ${localStorage.getItem("userTokenLG")}`,
      },
    })
      .then((res) => {
        this.setState({
          favorited: res.data.classified_favorites[0].vehicle_listing
            ? true
            : false,
        });
      })
  ...
  favorite() {
    ...
    if (this.state.favorited) {
      Axios.delete(
        `http://127.0.0.1:8000/api/listing/favorites/?vehicleId=${id}`,
        {
          headers: {
            Authorization: `Token ${localStorage.getItem("userTokenLG")}`,
          },
      ...
      <div className="classifiedsItem">
        ...
        <div className="section">
          ...
          <div className="sectionContainer">
            <div
              className={
                this.state.showMoreDetails ? "details" : "details collapse"
              }
            >
